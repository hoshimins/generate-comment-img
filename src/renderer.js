...
function fitText(ctx, settings, comment) {
    ...
    const availableH = box.h - padding * 2 - nameSize - 12;
...
export function render(ctx, settings, comment, bgImage) {
    // Clear
    ...
    ctx.restore();
    // Comment body
    const startY = box.y + padding + nameSize + 12;
    ctx.save();
